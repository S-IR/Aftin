...
export const determineSorts = (subCat: SMALL_CATEGORY_OF_IMG): {
  ...
  let [paid, size, color_scheme, menu_size, surr_env, appetizer_type, dish_type, soup, fast_food_type, sweet_type, drink_type, utensil_type,material,  ingredients, style, banner_type, artwork_style, sticker_category, logo_type, shape] = [false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false]
  color_scheme = paid = true
  if (StockImagesOptions.includes(subCat)) surr_env = true
