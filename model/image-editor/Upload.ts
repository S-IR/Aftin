...
import { canvasPagesActions, canvasPagesSlice } from "../../features/canvasPages/canvas-elements/canvasPageSlice";
import { shapeData } from "../../features/canvasPages/canvas-elements/shapeHandlingReducer";
import { ADD_TEXT_FILTER, textData } from "../../features/canvasPages/canvas-elements/textHandlingReducer";
import filtersSlice, { filtersActions } from "../../features/canvasPages/canvas-elements/filtersSlice";
...
export const uploadShapeToCanvas = (
  ...
  dispatch(ADD_SHAPE({
    ...
    data: {
      ...
      ...(shapeData.innerRadius !== undefined) && { innerRadius: shapeData.innerRadius },
      ...(shapeData.outerRadius !== undefined) && { outerRadius: shapeData.outerRadius }

    }
  }
  ))
  dispatch(ADD_SHAPE_FILTER({pageId, data: {
    type: 'shape',
    filter: {
      fill: `#000000`,
      stroke: `#000000`,
