...
interface props {
  color_scheme: HTMLHexColor[] | undefined
}

const SortColorScheme = ({ color_scheme }: props) => {

  const [open, setOpen] = useState(false)
  const handleClick = () => setOpen((open) => (!open))
  const handleOptionClick = (value: string | object) => console.log('hey')

  // setSorts((sorts: SidebarSorts) => {
...
export default SortColorScheme