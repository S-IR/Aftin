...
function HomeIntro() {
  ...
  return (
    ...
    <p ref={animatedDOM} className={`text-fuchsia-600 opacity-0 transition ease-in duration-[1000ms] ${animatedDOMVisible? "opacity-100" : ""}`} > Do you have an<span className=' text-red-900'> exquisite restaurant </span> with an atmosphere that people love?
    </p>
    <p ref={animatedDOM} className={`text-fuchsia-600 opacity-0 transition ease-in duration-[2000ms] ${animatedDOMVisible? "opacity-100" : ""}`} >
      One with <span className=' text-red-900'> mouthwatering </span> food that delights customers?
    </p>
    <p ref={animatedDOM} className={`text-fuchsia-600 opacity-0 transition ease-in duration-[3000ms] ${animatedDOMVisible? "opacity-100" : ""}`} >
