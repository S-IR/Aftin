  ...
  return (
    <section className="relative h-[800px] flex-col justify-center space-y-8  overflow-hidden border-2 border-dashed border-brown-900/40 bg-white/10 pt-10 text-center text-2xl shadow-white drop-shadow-xl">
      ...
      <a.h2
        style={hTwoStyles}
        ref={hTwoRef}
        className={`!m-0 translate-y-20 bg-gradient-to-br from-red-300 to-white bg-clip-text font-Handwriting text-6xl text-transparent opacity-0 transition-all  duration-1000 ease-out md:text-8xl `}
      >
