...
import { changeCanvasSize, handleAddPage, handleDeletePage } from '../../../model/image-editor/Canvas'
  ...
  return (
    <section className='h-[90vh] w-72 bg-gradient-to-br bg-gray-200 text-white shadow-md shadow-gray-500 flex flex-col'>
      ...
      <div className='w-full flex items-center justify-center align-middle flex-col space-y-6 mt-6'>
        <button className=' bg-brown-900 bg-opacity-70  h-12  flex align-middle hover:bg-gray-400 transition-all duration-300 w-56 justify-center hover:text-lg items-center drop-shadow-2xl shadow-gray-200'
          onClick={() => handleAddPage(dispatch)}
        >
          Add Page
        </button>
        {selected !== null && selected !== undefined && <button className='bg-brown-900 bg-opacity-70  h-12  flex align-middle hover:bg-gray-400 transition-all duration-300 w-56 justify-center hover:text-lg items-center drop-shadow-2xl shadow-gray-200 '
