...
//             const selected = mockupType === dayCategory.value;
...
//                   />
//                   <p
//                     className={`webkit !m-0 h-16 w-36 rounded-l-md rounded-r-md stroke-black text-center font-serif  text-2xl  drop-shadow-2xl transition-all duration-300 hover:border-gray-300  ${
