  ...
  return (
    <>
      <ListItemButton onClick={handleClick}
        className=' opacity-80 hover:opacity-100 w-16 h-32 md:h-auto  md:w-auto rounded-lg hover:translate-x-1 !transition-all !duration-300 !ease-in-out'
      >
        <ListItemIcon  >
          ...
          if (typeof (sortOption.value) === `string`) {
            ...
            return (
              <ListItemButton sx={{ pl: 4 }} key={sortOption.name}
                ...
                className={` hover:translate-x-2 !transition-all !ease-in-out !duration-300   ${isChecked ? `bg-black` : `bg-none`} `}
              >
                <ListItemIcon>
