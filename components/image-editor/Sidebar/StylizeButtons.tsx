  ...
  return (
    <div className='h-[100vh] w-96 bg-white shadow-inner  shadow-black'>
      {selected.element !== null ?
        ...
        <div className=' flex w-full items-center p-4 mt-6 justify-center align-middle bg-red-800 rounded-md shadow-md shadow-blue-300 h-1/4 text-2xl text-center font-serif'>
