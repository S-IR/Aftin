...
const SET_PREVIEW_IMAGE: CaseReducer<
  WritableDraft<previewImage>,
  PayloadAction<Blob | Blob[]>
> = (state, action) => {
  state.image = action.payload;
};

const CLEAR_PREVIEW_IMAGE: CaseReducer<
  WritableDraft<previewImage>,
  PayloadAction<void>
> = (state, action) => {
  state.image = null;
...
export const mockupsCount = (state: RootState) => state.previews;
