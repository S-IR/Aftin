...
export type queryType = {
  ...
  logo_type?: typeof logo_type_array, 
...
`paid`|`size`|`description`|`color_scheme`|`surr_env`|`dish_type`|`soup`|`food_type`|`drink_type`|`utensil_type`|`material`|`ingredients`|`banner_type`|`style`|`logo_type`|`artwork_style`|`sticker_category`|`shape` | `fast_food_type` | `sweet_type` | `menu_size`|`appetizer_type`