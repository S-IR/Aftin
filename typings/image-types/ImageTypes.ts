...
export const appetizers_array = [ `beef-carpaccio`, `beet-salad`, `bruschetta`, `caprese-salad`, `cevische`, `club-sandwich`, `crab-cake`, `deviled-eggs`, `escargots`, `falafel`, `gnocchi`, `greek-salad`, `guacamole`, `gyoza`, `oyster`, `ravioli`, `samosa`, `sashimi`, ` scallops`, `spring-rolls`, `takoyaki`]

export const main_dish_array = [
  `apple-pie`, `baby-back-ribs`,`beignets`, `bibimbap`, `bread-pudding`, `cannoli`, `carrot-cake`, `chicken-curry`, `chicken-wings`, `churros`, `dumplings`,
  `eggs-benedict`, `filet-mignon`, `fish-and-chips`, `french-toast`, `fried-rice`, `guacamole`, `hummus`, `lasagna`, `macaroni`, `mussels`, `omlette`, `oyster`, `pad-thai`, `paella`, `prime-rib`, `risotto`, `spagetti-bolognese`, `steak`, `steak-tartare`, `sushi`
]
...
export const fast_foods_array = [
  `fries`, `burgers`, `tacos`, `pizzas`, `nuggets`, `pretzels`, `hot-dogs`, `nachos`
]
